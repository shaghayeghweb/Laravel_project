...
sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"No data available in table",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ داده",sInfoEmpty:"نمایش 0 تا 0 از 0 داده",sInfoFiltered:"(فیلتر از _MAX_ کل داده)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ داده",sLoadingRecords:"بارگذاری...",sProcessing:"در حال پردازش...",sSearch:"جستجو کردن:",sSearchPlaceholder:"اینجا جستجو کنید...",sUrl:"",sZeroRecords:"موردی پیدا نشد"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
